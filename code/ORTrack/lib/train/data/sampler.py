    ...
    def getitem(self):
        ...
        while not valid:
            ...
            if is_video_dataset:
                ...
                elif self.frame_sample_mode == "contest_curriculum":
                    if not hasattr(dataset, "sample_pair_ids"):
                        raise ValueError("contest_curriculum sampler requires dataset.sample_pair_ids")
                    while search_frame_ids is None:
                        template_frame_ids, search_frame_ids = dataset.sample_pair_ids(seq_id, visible, self.max_gap)
