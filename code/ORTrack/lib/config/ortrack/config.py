...
cfg.TRAIN.FREEZE_BACKBONE_EXCEPT_LAST_N = -1
...
cfg.DATA.CONTEST = edict()
cfg.DATA.CONTEST.MANIFEST = ""
cfg.DATA.CONTEST.DATA_ROOT = ""
cfg.DATA.CONTEST.SPLIT_FILE = ""
cfg.DATA.CONTEST.SPLIT_FILE_VAL = ""
cfg.DATA.CONTEST.FRAME_CACHE_DIR = ""
cfg.DATA.CONTEST.CURRICULUM_STAGE = 1
cfg.DATA.CONTEST.TEMPORAL_STRATEGY = "near"
cfg.DATA.CONTEST.VELOCITY_AWARE = False
cfg.DATA.CONTEST.VELOCITY_AWARE_PROB = 0.0
cfg.DATA.CONTEST.HARD_SAMPLE_PROB = 0.0
cfg.DATA.CONTEST.MIN_AREA_RATIO = 0.0
cfg.DATA.CONTEST.MAX_MOTION_OBJ = 0.0
cfg.DATA.CONTEST.MAX_SCALE_CHANGE = 0.0
cfg.DATA.CONTEST.MIN_PAIR_AREA_RATIO = 0.0
cfg.DATA.CONTEST.SIZE_BUCKET_WEIGHTS = []
cfg.DATA.CONTEST.MIN_VALID_FRAMES = 20
# DATA.TRAIN
...
cfg.TEST.EPOCH = 500
cfg.TEST.POST_PROCESS = edict()
cfg.TEST.POST_PROCESS.ENABLE = False
cfg.TEST.POST_PROCESS.SMOOTH_ALPHA = 0.75
cfg.TEST.POST_PROCESS.LOW_CONF_ALPHA = 0.45
cfg.TEST.POST_PROCESS.LOW_CONF_THRESHOLD = 0.20
cfg.TEST.POST_PROCESS.MAX_CENTER_JUMP_OBJ = 5.0
cfg.TEST.POST_PROCESS.MAX_SCALE_CHANGE = 2.0
cfg.TEST.POST_PROCESS.MIN_BOX_SIZE = 2.0
cfg.TEST.POST_PROCESS.TEMPLATE_UPDATE = False
cfg.TEST.POST_PROCESS.TEMPLATE_UPDATE_CONF = 0.55
cfg.TEST.POST_PROCESS.TEMPLATE_UPDATE_INTERVAL = 25
